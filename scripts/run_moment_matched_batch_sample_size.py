"""Wrapper: moment-matched entropy batch for sample_size only. Forwards extra CLI args."""
...
if __name__ == "__main__":
    extra = sys.argv[1:]
    sys.argv = [str(Path(__file__).resolve()), "--batch", "--experiments", "sample_size"] + extra
    _mod.main()
