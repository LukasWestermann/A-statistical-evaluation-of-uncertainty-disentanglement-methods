"""Wrapper: moment-matched entropy batch for undersampling only. Forwards extra CLI args."""
...
if __name__ == "__main__":
    extra = sys.argv[1:]
    sys.argv = [str(Path(__file__).resolve()), "--batch", "--experiments", "undersampling"] + extra
    _mod.main()
