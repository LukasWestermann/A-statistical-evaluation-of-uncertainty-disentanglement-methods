"""Wrapper: moment-matched entropy batch for OOD only. Forwards extra CLI args (e.g. --grid-stride, --out-root)."""
...
if __name__ == "__main__":
    extra = sys.argv[1:]
    sys.argv = [str(Path(__file__).resolve()), "--batch", "--experiments", "ood"] + extra
    _mod.main()
